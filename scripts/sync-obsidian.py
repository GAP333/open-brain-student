...
UNSORTED = "Unsorted"
GENERATED = list(BUCKET_FOLDERS.values()) + [UNSORTED, "Tasks", "Recaps", "Contacts"]
...
def main():
    ...
    # Tasks: one checklist note per bucket
    ...
    for b, label in BUCKET_LABELS.items():
        ...
        (VAULT / "Tasks" / f"{BUCKET_FOLDERS[b]}.md").write_text("\n".join(lines) + "\n")
    ...
    home = [
        ...
        "- Notes live in GCU / Legacy / School / Personal / Unsorted",
